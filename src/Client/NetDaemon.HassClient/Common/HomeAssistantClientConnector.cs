...
//        //var pipeLineFactory = new WebSocketClientTransportPipelineFactory(optionsSettings, loggerFactory);
//        var websocketClientFactory = new WebSocketClientFactory(Options.Create(settings));
//        var client = new HomeAssistantClient(loggerClient,

//            websocketClientFactory, pipeLineFactory, connectionFactory);
